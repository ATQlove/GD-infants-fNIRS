...
The resulting graph is plotted as follows:

![PSD_log_contrast](.\File for README\Figure 3.jpg)
...
![PSD_log_move](.\File for README\Figure 4.jpg)
...
![Phase_Contrast](.\File for README\Figure 6.jpg)

![Phase Contrast](.\File for README\Figure 7.jpg)
...
![color_topplot](.\File for README\Figure 2.jpg)
...
At this point, the t-test between channels is completed and the final results are plotted as follows:

![channel](.\File for README\Figure 5.jpg)



There is another key diagram in visualization, that is, the placement of the channel when collecting data. Find the location diagram of the 10-20 System used in the data set, combined with Visio and other software to draw the following:

![optode](.\File for README\Figure 1.jpg)
